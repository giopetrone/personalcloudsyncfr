 ...
 */
public class ExistantTable extends ListActivity{
		    ...
		    super.onCreateContextMenu(menu, v, menuInfo);  
	 		  ...
	 		  @Override  
			    ...
			    public boolean onOptionsItemSelected(MenuItem item) {
			        ...
			        case R.id.add_obj:
			        	AlertDialog.Builder myDialog=new AlertDialog.Builder(ExistantTable.this);
				        myDialog.setTitle("Add Object"); 
				        TextView textView = new TextView(ExistantTable.this);
				        textView.setText("Insert new web address");
				        LayoutParams textViewLayoutParams=new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
				        textView.setLayoutParams(textViewLayoutParams);
				        newUrl = new EditText(ExistantTable.this);
				        ...
				        LinearLayout layout=new LinearLayout(ExistantTable.this);
			        ...
			        case R.id.info_tab:
			        	...
			        	AlertDialog.Builder builder=new AlertDialog.Builder(ExistantTable.this);
