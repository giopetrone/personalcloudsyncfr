<%--
    Document   : consumer_redirect
    Created on : Feb 8, 2010, 3:24:24 PM
    Author     : giovanna
--%>
...
<%
    ...
    String openid="https://www.google.com/accounts/o8/id";
        ...
        try
        {
         ...
         //   String returnToUrl = "http://localhost:8081/OpenIdSpike/consumer_returnurl.jsp";
             String returnToUrl = "http://localhost:8081/NotifMgr/index.jsp";
