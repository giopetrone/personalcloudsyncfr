...
/**
 * Example class using the GWTDocWatcherService service.
 *
 * @author giovanna
 */
public class GWTDocWatcherServiceUsageExample extends VerticalPanel {
    private Label lblServerReply = new Label();
    private TextBox txtUserInput = new TextBox();
    private Button btnSend = new Button("Send to server");
    
    public GWTDocWatcherServiceUsageExample() {
