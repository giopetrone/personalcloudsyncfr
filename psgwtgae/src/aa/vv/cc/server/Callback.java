    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (hubmode.equals("subscribe")) {
            	System.err.println("in callback, modo normale");
            	...
            	System.err.println("in callback, notifica");
                if (printHeaders) {
                ...
                if (debugStream ) {
                    ...
                    try {
                        ...
                        //	System.err.println("dopo many");
                            ...
                            //    System.err.println(description + " " +entry.getTitle());
