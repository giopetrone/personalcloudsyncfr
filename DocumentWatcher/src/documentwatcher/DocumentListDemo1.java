 ...
 *
 */
public class DocumentListDemo1 {
   ...
   */
  public DocumentListDemo1(PrintStream outputStream, String appName, String host)
      throws DocumentListException {
    out = outputStream;
  ...
  private boolean executeCommand(BufferedReader reader)
      throws Exception, ServiceException, InterruptedException {
  ...
  public static void main(String[] args)
    ...
    String authSub=null;
    String user = "sgnmrn@gmail.com"; //parser.getValue("username", "user", "u");
    String password = "micio11"; //parser.getValue("password", "pass", "p");
   ...
   // boolean help = parser.containsKey("help", "h");
    ...
    DocumentListDemo1 demo = new DocumentListDemo1(System.out, APPLICATION_NAME,
        host);
