...
public class ChatClient implements MessageListener {
    ...
    /* ORIGINALE - meglio non usare perche' causa parecchie eccezioni...
        ...
        System.err.println("---------------- in sendGTalkMsg, dopo la send a " + receiver);
        if (test) {
            this.displayBuddyList();
...
*/
    ...
    public static void main(String args[]) throws XMPPException, IOException {
        ...
        chClient.sendGTalkMsg("liliana.ardissono@gmail.com", "gio.petrone@gmail.com", "mer20ia05", "testoMessaggio", true);
    }
     * */
