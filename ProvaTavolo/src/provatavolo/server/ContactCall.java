...
import provatavolo.server.ContactsExampleParameters.Actions;
...
//String[] myArg = {"--username=gio.petrone@gmail.com", "--password=mer20ia05" }; vecchia pwd
...
//  String[] myArg = {"--username=annamaria.goy@gmail.com", "--password=tex_willer", "-groupfeed", "--action=list"};
        ...
        String[] myArg = {"--username=annamaria.goy@gmail.com", "--password=tex_willer", "--contactfeed", "--action=update", "--id=http://www.google.com/m8/feeds/contacts/annamaria.goy%40gmail.com/base/38aa1dea099ac975", "--groupid2=32af7f8d8a54cb99"};   ContactsExampleParameters parameters = new ContactsExampleParameters(myArg); // X USAGE
