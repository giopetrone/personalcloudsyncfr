...
public class SendAllMessagesServlet extends BaseServlet {
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (devices.isEmpty()) {
     ...
     // Queue queue = QueueFactory.getQueue("gcm");
      ...
      if (devices.size() == 1) {
        ...
        queue.add(withUrl("/gcmdemo4/send").param(
            SendMessageServlet.PARAMETER_DEVICE, device));
        System.out.println("Passato : queue.add(withUrl(/gcmdemo4/send).");
   ...
   getServletContext().getRequestDispatcher("/gcmdemo4/home").forward(req, resp);
  }
