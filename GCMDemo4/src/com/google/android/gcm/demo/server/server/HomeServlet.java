...
public class HomeServlet extends BaseServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (total == 0) {
      ...
      out.println("<h2>" + total + " device(s) registered!</h2>");
      out.println("id:" + Datastore.getDevices().toString());
      out.println("alfonso id da email :" + Datastore.getRegIdFromEmail("alfonso.disalvo@gmail.com").toString());
      
      out.println("chiamata servlet sendAll :");
      out.println("<form name='form' method='POST' action='sendAll'>");
