...
/**
 * Example class using the GWTUserAgentService service.
 *
 * @author giovanna
 */
public class GWTUserAgentServiceUsageExample extends VerticalPanel {
    private Label lblServerReply = new Label();
    private TextBox txtUserInput = new TextBox();
    private Button btnSend = new Button("Send to server");
    
    public GWTUserAgentServiceUsageExample() {
