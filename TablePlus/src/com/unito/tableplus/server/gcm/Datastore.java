...
public final class Datastore {
	 ...
	 */
	public static void register(String regId, String utente) {
		...
		try {
			...
			entity.setProperty("user", utente);
	...
	public static List<String> getRegIdFromEmail(String user) {
		List<String> devices;
		Transaction txn = datastore.beginTransaction();
		try {
			Query query = new Query(DEVICE_TYPE).addFilter("user",
